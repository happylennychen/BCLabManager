...
namespace O2Micro.BCLabManager.Database
{
    /// <summary>
    ...
    public class SQLiteDriver
    {
        ...
        public void ExecuteNonQuery(string sql, ref int row)
        {
            try
            {
        ...
        public void ExecuteNonQueryTransaction(List<string> sqls)
        {
            using (SQLiteConnection conn = new SQLiteConnection(connstr))
            {
                conn.Open();
        ...
        public void ExecuteSelect(string sql, ref DataTable dt, ref int row)
        {
            try
            {
                using (SQLiteConnection conn = new SQLiteConnection(connstr))
        ...
        public void ExecuteReader(string sql, ref SQLiteDataReader dr)
        {
            try
            {
        ...
        public void DBCreateTable(string tablename, Dictionary<string, string> column)
        {
        ...
        public void DBMultipleInsertInto(string tablename, DataTable dt)
        {
        ...
        public void DBMultipleInsertInto(string tablename, List<Dictionary<string, string>> records)   //指定colname
        {
        ...
        public void DBMultipleInsertInto(string tablename, List<List<string>> records)                 //不指定colname
        {
            List<string> sqls = new List<string>();
            foreach (var record in records)
            {
        ...
        public string SQLInsertInto(string tablename, Dictionary<string, string> records)
        {
        ...
        public void DBInsertInto(string tablename, Dictionary<string, string> records, ref int row)
        {
            List<string> columns = records.Keys.ToList<string>();
            List<string> values = records.Values.ToList<string>();
        ...
        public string SQLInsertInto(string tablename, List<string> columns, List<string> values)
        {
            string sql = "INSERT OR IGNORE INTO " + tablename + "(";
        ...
        public void DBInsertInto(string tablename, List<string> columns, List<string> values, ref int row)
        {
            string sql = SQLInsertInto(tablename, columns, values);
            ExecuteNonQuery(sql, ref row);
        }
        public void DBUpdate(string tablename, Dictionary<string, string> condition, Dictionary<string, string> records, ref int row)
        {
        ...
        public void DBUpdate(string tablename, List<string> conditioncolumns, List<string> conditionvalues, List<string> datacolumns, List<string> datavalues, ref int row)
        {
        ...
        public void DBUpdateOrInsert(string tablename, Dictionary<string, string> condition, Dictionary<string, string> records, ref int row)
        {
            List<string> conditioncolumns = condition.Keys.ToList<string>();
            List<string> conditionvalues = condition.Values.ToList<string>();
            List<string> datacolumns = records.Keys.ToList<string>();
        ...
        public void DBUpdateOrInsert(string tablename, List<string> conditioncolumns, List<string> conditionvalues, List<string> datacolumns, List<string> datavalues, ref int row)
        {
            string sql = "UPDATE " + tablename + " SET ";
            for (int i = 0; i < datacolumns.Count; i++)
            {
        ...
        public void DBSelect(string tablename, Dictionary<string, string> conditions, List<string> datacolumns, ref List<List<string>> datavalues, ref int row)
        {
        ...
        public void DBSelect(string tablename, Dictionary<string, string> conditions, List<string> datacolumns, ref DataTable dt, ref int row)
        {
            string sql = "SELECT ";
            if (datacolumns == null)
            {
        ...
        public void DBDelete(string tablename, Dictionary<string, string> conditions, ref int row)
        {
